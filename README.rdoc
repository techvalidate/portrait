...
Portrait is a Rails 4 application. So you'll need some kind of Rails stack. For OS X your best bet is to just use the included Apache install along with Passenger.
